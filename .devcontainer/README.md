...
Includes FFmpeg, FLAC, SoX, MediaInfo, Chromaprint, rsgain, BPM tools and
parity utilities, plus CI-pinned ShellCheck 0.11.0. Run `make test-all` for
codec integration coverage.
Proprietary codecs and optical-disc hardware remain optional. Use disposable
media fixtures.
