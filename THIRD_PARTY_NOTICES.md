...
See `docs/third-party.md` where present for tool and source attribution.
Installed codecs and audio programs retain their own licenses. Bundling their
binaries requires the notices and source obligations for the exact builds.
